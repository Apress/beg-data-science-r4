...
## ----iris-coloured-according-to-species-qplot, fig.cap="Plot of iris data with colours determined by the species. Plotted with qplot (ggplot2).", echo=FALSE----
...
## ----longley-data-plotted-with-tidyr, fig.cap="Longley data plotted using tidy data.", echo=FALSE----
longley %>% 
  pivot_longer(
  ...
  ggplot(aes(x = Year, y = `Number of People`, color = Class)) + 
